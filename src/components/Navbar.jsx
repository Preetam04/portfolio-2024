...
const Navbar = () => {
  return (
    <div className=" h-14  w-full flex flex-row fixed items-center bg-lightBg justify-between px-3 sm:px-10 z-20 ">
      {/* name and icon */}
      ...
      <div className="flex flex-row w-fit sm:gap-5 md:gap-10">
        <ol className="sm:flex  flex-row items-center font-medium sm:gap-5 md:gap-10 opacity-60 text-TextColor font-normalText hidden">
          <a href="#about">
            <li className=" transition-all   md:text-lg ease-in delay-100 cursor-pointer hover:text-primaryColor hover:font-semibold hover:translate-x-2 py-0.5">
              About
            </li>
          </a>
          <a href="/#services">
        ...
        <a href="/#contact">
          <button className="bg-primaryColor  text-white font-normalText px-3 py-2 font-bold rounded-md w-fit h-fit">
            Let's Talk
          </button>
        </a>
      </div>
